...
include_once(TPCORE_ADDONS_DIR . '/include/custom-post-loan.php');
 ...
 * TP Custom Widget
 */
include_once(TPCORE_WIDGET_PATH . '/tp-blog-post-category-sidebar.php');
...
final class TP_Core
{
	...
	public function admin_notice_missing_main_plugin()
	{
		...
		$message = sprintf(
			...
			esc_html__('"%1$s" requires "%2$s" to be installed and activated.', 'finview'),
			'<strong>' . esc_html__('Tp Core', 'finview') . '</strong>',
			'<strong>' . esc_html__('Elementor', 'finview') . '</strong>'
		);
	...
	public function admin_notice_minimum_elementor_version()
	{
		...
		$message = sprintf(
			...
			esc_html__('"%1$s" requires "%2$s" version %3$s or greater.', 'finview'),
			'<strong>' . esc_html__('Tp Core', 'finview') . '</strong>',
			'<strong>' . esc_html__('Elementor', 'finview') . '</strong>',
	...
	public function admin_notice_minimum_php_version()
	{
		...
		$message = sprintf(
			...
			esc_html__('"%1$s" requires "%2$s" version %3$s or greater.', 'finview'),
			'<strong>' . esc_html__('Tp Core', 'finview') . '</strong>',
			'<strong>' . esc_html__('PHP', 'finview') . '</strong>',
