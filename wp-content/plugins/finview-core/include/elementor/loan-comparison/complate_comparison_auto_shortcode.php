...
class TP_loan_comparison extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        $shortcode_attrs = array(
            ...
            // 'min_term' => $settings['min_loan_term'],
            // 'rating' => $settings['rating'],
            // 'max_term' => $settings['max_loan_term'],
        ...
        // $shortcode_attr_string = '';
        foreach ($loan_data as $key => $value) {
            // $shortcode_attr_string .= ' ' . $key . '="' . esc_attr($value) . '"';
            echo ' Repayment period: ';
            echo $value['min_term'] . '-' . $value['max_term'];
            echo ' </br>';
        }
        ...
        // Add custom JavaScript to handle widget interactions
?>
<?php
    }
}
