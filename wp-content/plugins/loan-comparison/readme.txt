...
Contributors: 
Tags: loans, banks, comparison, repayments
...
**READ THIS!** There will be no further updates to this plugin except to fix security bugs and ensure compatibility with the latest version of WordPress. The plugin isn't going to be deleted but I have built a new Comparison Plugin that is so much easier to manage and update. [See the demo](https://comparisonplugin.com). [Get the plugin](https://wordpress.org/plugins/comparisons/).
...
= 2.0 =
*	Cleaned up a load of code
*	Updated the settings layout (easier to manage)
*	Added new filters and data validation
*	Improved credit score CSS
